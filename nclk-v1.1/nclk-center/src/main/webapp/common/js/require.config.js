require.config({
    ...
    paths:{
        ...
        'echarts':'plugins/echarts/echarts.four.self.min',
        ...
        'jquery-placeholder':'plugins/jquery-placeholder/jquery.placeholder.min',
    ...
    shim:{
        ...
        'ztree':['jquery','css!plugins/ztree/css/customzTreeStyle'],
