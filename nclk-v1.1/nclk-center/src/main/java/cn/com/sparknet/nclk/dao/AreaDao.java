...
public class AreaDao {
	...
	public List<Map<String, Object>> findAreaIdAndCheck(String provinceName,String cityName,String districtName ){
		...
		sql.append("SELECT AREA_ID FROM T_NCLK_AREA WHERE (AREA_ID =(SELECT PARENT_AREA_ID FROM T_NCLK_AREA WHERE  ");
		sql.append("AREA_ID=(SELECT PARENT_AREA_ID FROM T_NCLK_AREA  WHERE AREA_NAME=?))  ");
