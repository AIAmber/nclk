...
<body>
  ...
  <link href="<%=path %>/manage/css/user.css" rel="stylesheet">
  ...
  <div style="display:none">
   ...
   <!-- 修改用户管理模态框 -->
  <div style="display:none">
      <form  class=" form-horizontal" id="userEditForm" style="width:973px;">
        <div style="float:left;width:549px">
            <div style="margin-bottom:32px">
              <img id="preview_edit" src="<%=path %>/common/img/head.png"  onerror="this.src='<%=path %>/common/img/head.png'">
              <div id="btnGroup_edit">
                <a id="uploadUserPhoto_edit" class="btn btn-default btn-sm" style="float: left;">上传
                  <input type="file" name="PHOTO_edit" id="PHOTO_edit" />
                </a>
                <a id="deleteUserPhoto_edit"  class="btn btn-default btn-sm"  style="float: right;cursor: pointer">删除</a>
              </div>
              <input type="hidden" name="photofilePath_edit">
            </div>
           <div class="form-group" style="display:none">
              <label for="userId" class="control-label col-sm-2">用户ID</label>
              <div class="col-sm-4">
                  <input type="text" class="form-control" id="userId_edit" name="userId_edit"/>
              </div>
          </div>
           <div class="form-group">
              <label for="perName" class="control-label col-sm-2"><font class="red">*</font>姓名</label>
              <div class="col-sm-4">
                  <input type="text" class="form-control" id="perName_edit" name="perName_edit"/>
              </div>
          </div>
          <div class="form-group">
              <label for="userName" class="control-label col-sm-2" ><font class="red">*</font>用户名</label>
          ...
          <div id="passwordInput_edit" class="form-group">
              <label for="password" class="control-label col-sm-2" ><font class="red">*</font>密码</label>
              <div class="col-sm-4">
                  <input type="password" class="form-control"  id="addPassword_edit" name="addPassword_edit" autocomplete="off"/>
              </div>
          </div>
          <div id="confirmPasswordInput_edit" class="form-group">
              <label for="confirmPassword" class="control-label col-sm-2"><font class="red">*</font>确认密码</label>
              <div class="col-sm-4">
                  <input type="password" class="form-control"  id="addConfirmPassword_edit" name="addConfirmPassword_edit" autocomplete="off"/>
              </div>
          </div>
          <div class="form-group">
              <label for="state" class="control-label col-sm-2"><font class="red">*</font>状态</label>
          ...
          <label for="authority" class="control-label " style="margin-left:42px">权限</label>
              <div class="form-group">
              <div class="col-sm-6" style="margin-left:53px;width:222px">
                  <div id="authority-tree-edit" style="max-height:230px;overflow-y:auto" >
                      <ul id="authority-treeContent-edit" class="ztree"></ul>
                  </div> 
              </div>
            </div>
          </div>
          ...
          <label for="manageArea" class="control-label" style="margin-left:72px">管辖区域</label>
           <div class="form-group">
              <div class="col-sm-6" style="margin-left:80px">
                  <div id="manageArea-tree-edit" style="overflow-y:auto;height:338px;width:239px;margin-top:7px;" >
                     <ul id="manageArea-treeContent-edit" class="ztree"></ul>
                  </div>        
              </div>
          </div>
          </div>
          <div id="warnText">
					   <p>修改完成后需重新登录系统使信息生效!</p>
					</div>
  ...
  <!--区域管理设置模态框  -->
   <div style="display:none">
      <form class="form-horizontal" id="manageAreaForm">
          <div id="manageArea-treeDialog" style="overflow-y:auto;width:400px;height:395px;margin-top:7px;" >
