...
public class AreaController {
	...
	@ResponseBody
	public String getProvinceAll(HttpServletRequest request,HttpServletResponse response){
	...
	@ResponseBody
	public String getCityAll(HttpServletRequest request,HttpServletResponse response){
		//父节点id
		String parentAreaId=StringUtil.nullToEmpty(request.getParameter("parentAreaId"));
		return areaService.getChildAreaByParentAreaId(parentAreaId);
	}
	...
	public String getDistrictAll(HttpServletRequest request,HttpServletResponse response){
		//父节点id
		String parentAreaId=StringUtil.nullToEmpty(request.getParameter("parentAreaId"));
		return areaService.getChildAreaByParentAreaId(parentAreaId);
	}
