...
<body>
				...
				<!--搜索框  -->
				 <div class="btn_searchDiv" style="float:right">
				     <div class="has-feedback">
				    	...
				    	<p class="glyphicon glyphicon-remove btn form-control-feedback chear_input" id="normal_delete" style="display: none"></p>
				     </div>
				...
				<button id="normalClock" class='btn btn-default btn-info'>启用</button>
				 ...
				 <div class="btn_searchDiv" style="float:right">
				     <div class="has-feedback">
				    	...
				    	<p class="glyphicon glyphicon-remove btn form-control-feedback chear_input" id="disable_delete" style="display: none"></p>
				     </div>
				     <span class="input-group-btn">
	...
	<div id="endPointAutoSearch" style="display:none">
		<form class="form-inline clearfix" id="endPointAutoSearchForm">
			...
			<div class="error_statusul" style="height: 250px;width: 618px;overflow-x:hidden;overflow-y:auto;margin-top: 3px;margin-bottom: 3px;">
			...
			<div id="addAutoSearchClockInfo"></div>
		</form>
	</div>
	<!-- 编辑子钟信息 -->
