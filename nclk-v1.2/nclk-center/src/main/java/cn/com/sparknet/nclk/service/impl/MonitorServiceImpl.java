...
public class MonitorServiceImpl implements MonitorService {
    ...
    @Override
    public ListJson findHistoryErrorInfo(String examroomId, String userId, String start, String limit, String searchText, String startTime, String endTime) {
        Page page;
        try {
            page = monitorDao.findHistoryErrorInfo(examroomId, userId, start, limit, searchText, startTime, endTime);
        } catch (ParseException e) {
            throw new RuntimeException(e.getMessage(), e);
        }
        ListJson listJson = new ListJson();
    ...
    public void deleteOldLog() {
        monitorDao.deleteOldLog();
    }

    @Override
    public void deleteOldHisLog() {
        monitorDao.deleteOldHisLog();
    }
