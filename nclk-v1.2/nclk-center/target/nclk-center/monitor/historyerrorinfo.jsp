...
<script src="<%=path %>/monitor/js/historyerrorinfo.js"></script>
<div class="panel panel-default panel-nobody">
    <div class="table-toolbar clearfix">
        ...
        <div class="btn-group btn-group-sm pull-right">
            <a href="JavaScript:history.go(-1);" id="btn-back" class="btn btn-default"><span class='glyphicon glyphicon-share-alt'></span>&nbsp;返回</a>
